...
本目录是产品 / 架构 / 接口的**单一事实来源**。前后端 agent 在并行开发时，所有跨职责的字段、事件名、状态机都以本目录为准；任何冲突优先以 [API-CONTRACT.md](./API-CONTRACT.md) 为锚点。

## 文档导航

| # | 文档 | 受众 | 用途 |
|---|------|------|------|
| 1 | [PRD.md](./PRD.md) | 全员 | 产品定位、用户、范围、里程碑 |
| 2 | [ARCHITECTURE.md](./ARCHITECTURE.md) | 全员 | 技术栈、模块边界、部署形态 |
| 3 | [GAME-RULES.md](./GAME-RULES.md) | 后端 / QA | 三种玩法的规则与边界用例 |
| 4 | [API-CONTRACT.md](./API-CONTRACT.md) | **前后端共同遵守** | REST + Socket.IO 事件契约 |
| 5 | [UI-DESIGN.md](./UI-DESIGN.md) | 前端 / 设计 | 视觉规范、页面与组件 |
| 6 | [AI-BOTS.md](./AI-BOTS.md) | 后端 | 人机插件接口与各玩法策略 |
